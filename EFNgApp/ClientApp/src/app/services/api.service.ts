...
import {KeyMetrics, ModelCommodity, RecordsByCommodity} from "../pages/dashboard/data-model";
...
export class ApiService {
    ...
    public getGetModelCommodity(): Observable<ModelCommodity[]> {
        return this.http.get<ModelCommodity[]>(`${environment.backend}/GetModelCommodity`);
    }
